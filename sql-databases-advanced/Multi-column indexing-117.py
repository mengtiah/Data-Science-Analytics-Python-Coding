...
query_plan_one=conn.execute("explain query plan select * from facts where\
                            population>100000 and population_growth<0.05;").fetchall()
...
query_plan_two=conn.execute("explain query plan select * from facts where population>1000000 and population_growth<0.5;").fetchall()
